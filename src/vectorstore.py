...
class FaissVectorStore:
    def __init__(self, persist_dir: str = "faiss_store", embedding_model: str = "mxbai-embed-large",
        ...
        print(f"[INFO] Connected to Ollama model: {embedding_model}")
    ...
    def query(self, query_text: str, top_k: int = 5):
        ...
        query_emb_list = self.model.embed_query(query_text)
...
if __name__ == "__main__":
    ...
    store.load()
    print(store.query("What is Computer Network", top_k=3))